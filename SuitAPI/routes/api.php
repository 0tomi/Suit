...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/cases/sync', [\App\Http\Controllers\CaseController::class, 'syncDown']);
    ...
    Route::post('/cases/sync', [\App\Http\Controllers\CaseController::class, 'syncUp']);
    ...
    Route::post('/documents/{document}/lock', [\App\Http\Controllers\DocumentController::class, 'lock']); // DOCUMENTADA
    Route::delete('/documents/{document}/lock', [\App\Http\Controllers\DocumentController::class, 'unlock']); // DOCUMENTADA
    ...
    Route::apiResource('radicaciones', \App\Http\Controllers\RadicacionController::class);
