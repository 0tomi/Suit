...
test('normal user cannot create template category', function () {
    $normalUser = User::factory()->create(['role' => 'lawyer']);
    $data = [
        'name' => 'Contratos',
...
test('normal user cannot update a template category', function () {
    $normalUser = User::factory()->create(['role' => 'lawyer']);
    $category = TemplateCategory::factory()->create();
...
test('normal user cannot delete a template category', function () {
    $normalUser = User::factory()->create(['role' => 'lawyer']);
    $category = TemplateCategory::factory()->create();
